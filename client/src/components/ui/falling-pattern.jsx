...
export function FallingPattern({
  ...
  return (
    <div className={cn("pointer-events-none relative h-full w-full overflow-hidden", className)} {...props}>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `linear-gradient(180deg, rgba(255,255,255,0.04), rgba(255,255,255,0.16)), radial-gradient(circle at 50% 50%, transparent 0, transparent 2px, rgba(255,255,255,0.12) 2px)`,
          backgroundSize: `100% 100%, ${8 * density}px ${8 * density}px`,
        }}
      />
    </div>
  );
